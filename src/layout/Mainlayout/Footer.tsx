...
const Footer = () => {
  ...
  return (
    <div style={styles} className="relative">
      <footer className="rounded-lg shadow bg-[#b3b9cb]  border-b-4 ">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            
            <ul className="flex flex-wrap items-center mb-6 text-sm font-bold text-black-500 sm:mb-0 dark:text-black-400">
              <li>
